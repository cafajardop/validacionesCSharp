...
namespace Calcular
{
    ...
    public class ENT_USFile : EntityBase
    {
        ...
        private string _AdministeringEntityCode;
        [Order]
        [Regex(@"^.{5,6}$", "La longitud válida son 6 caracteres")] public string AdministeringEntityCode { get { return _AdministeringEntityCode; } set { _AdministeringEntityCode = ValidateValue<string>(value, nameof(AdministeringEntityCode)); } }
        /// <sumary>
        /// TypePerson
        /// </sumary>
