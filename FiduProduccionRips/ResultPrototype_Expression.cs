...
namespace FiduProduccionRips
{
	...
	public static class Helper
    {
        ...
        public static ENT_ActionResult USR_SaveRipsFile(long IdFile, dynamic listSave)
        {
            try
            {
                ...
                string url = "https://fiduprevisora.digitalwaresaas.com.co:8085/ASSURANCE/api/Rips/" + controller;
        ...
        public static ENT_ActionResult USR_WSGetFile(long company, long libraryId, string fileId)
        {
            try
            {
                ...
                ENT_ActionResult result = new ENT_ActionResult();
                string url = "https://fiduprevisora.digitalwaresaas.com.co:8080/api/api/Upload/GetDocument";
        ...
        public static ENT_ActionResult SYS_WSExecuteQuery(long adapterId, string queryBD)
        {
            try
            {
                ...
                ENT_ActionResult result = new ENT_ActionResult();
                string url = "https://fiduprevisora.digitalwaresaas.com.co:8080/api/api/Adapter/ExecuteQuery";
        ...
        public static ENT_ActionResult SYS_WSRequest(string method, string url, object parameters, dynamic headers, string fileFullPath, double? minTimeout)
        {
            try
            {
                ...
                double min = minTimeout != null && minTimeout > 0 ? (double)minTimeout : 15;
        ...
        public static string USR_FtpUpload(string remoteFile, dynamic localFile)
        {
            try
            {
                string ftp = "10.70.2.15";
                string userName = "opheliaftp";
                string password = "%AdmClient80%*";
    ...
    public class ENT_AFFile : EntityBase
    {
        ...
        [Order]
        [Regex(@"^.{5,6}$", "La longitud del campo debe ser 5 ó 6 caracteres")] public string AdministeringEntityCode { get { return _AdministeringEntityCode; } set { _AdministeringEntityCode = ValidateValue<string>(value, nameof(AdministeringEntityCode)); } }
        /// <sumary>
    ...
    public class ENT_USFile : EntityBase
    {
        ...
        private string _AdministeringEntityCode;
        [Order]
        [Regex(@"^.{5,6}$", "La longitud válida son 5 ó 6 caracteres")] public string AdministeringEntityCode { get { return _AdministeringEntityCode; } set { _AdministeringEntityCode = ValidateValue<string>(value, nameof(AdministeringEntityCode)); } }
        /// <sumary>
        /// TypePerson
        /// </sumary>
