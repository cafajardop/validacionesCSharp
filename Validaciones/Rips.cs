...
{
    /// <sumary>
    /// SaveRipsFiles_Expression
    /// </sumary> 
    public sealed class SaveRipsFiles_Expression
    {
        #region Fields
        /// <sumary>
        /// FileName
        ...
        /// Fecha Inicio
        /// </sumary>
        private DateTime InitDateIn;
        /// <sumary>
        /// Fecha Final
        /// </sumary>
        private DateTime EndDateIn;
        /// <sumary>
        /// Id Tipo Población
        /// </sumary>
        private long IdTypePopulationIn;
        /// <sumary>
        /// Establecimiento
        /// </sumary>
        private long EstablishmentIn;
        /// <sumary>
        /// Código de seguimiento
        /// </sumary>
        private string TrackingCodeIn;
        /// <sumary>
        /// Código de usuario
        /// </sumary>
        ...
        /// Id archivo AC
        /// </sumary>
        private string ACFileIdIn;
        /// <sumary>
        /// Id archivo AF
        /// </sumary>
        private string AFFileIdIn;
        /// <sumary>
        /// Id archivo AH
        /// </sumary>
        private string AHFileIdIn;
        /// <sumary>
        /// Id archivo AM
        /// </sumary>
        private string AMFileIdIn;
        /// <sumary>
        /// Id archivo AN
        /// </sumary>
        private string ANFileIdIn;
        /// <sumary>
        /// Id archivo AP
        /// </sumary>
        private string APFileIdIn;
        /// <sumary>
        /// Id archivo AT
        /// </sumary>
        private string ATFileIdIn;
        /// <sumary>
        /// Id archivo AU
        /// </sumary>
        private string AUFileIdIn;
        /// <sumary>
        /// Id archivo CT
        /// </sumary>
        private string CTFileIdIn;
        /// <sumary>
        /// Id archivo US
        /// </sumary>
        private string USFileIdIn;
        /// <sumary>
        /// Id archivo AD
        /// </sumary>
        private string ADFileIdIn;
        /// <sumary>
        /// Mensaje de salida
        /// </sumary>
        private string ExitMessage;
        /// <sumary>
        /// Variable de estado de archivos guardados 
        /// </sumary>
        private bool SaveRipsFiles;
        #endregion
        ...
        /// </sumary>
        public SaveRipsFiles_Expression() { }
        #endregion
        ...
        /// SaveRipsFiles_Expression
        /// </sumary>
        /// <param name="CompanyIdIn">Id Empresa</param>
        /// <param name="OperatorIdIn">Id Operador</param>
        /// <param name="CaseNumberIn">Numero de caso</param>
        /// <param name="LibraryIdIn">Id de librería</param>
        /// <param name="InitDateIn">Fecha Inicio</param>
        /// <param name="EndDateIn">Fecha Final</param>
        /// <param name="IdTypePopulationIn">Id Tipo Población</param>
        /// <param name="EstablishmentIn">Establecimiento</param>
        /// <param name="TrackingCodeIn">Código de seguimiento</param>
        /// <param name="UserCodeIn">Código de usuario</param>
        /// <param name="ACFileIdIn">Id archivo AC</param>
        /// <param name="AFFileIdIn">Id archivo AF</param>
        /// <param name="AHFileIdIn">Id archivo AH</param>
        /// <param name="AMFileIdIn">Id archivo AM</param>
        /// <param name="ANFileIdIn">Id archivo AN</param>
        /// <param name="APFileIdIn">Id archivo AP</param>
        /// <param name="ATFileIdIn">Id archivo AT</param>
        /// <param name="AUFileIdIn">Id archivo AU</param>
        /// <param name="CTFileIdIn">Id archivo CT</param>
        /// <param name="USFileIdIn">Id archivo US</param>
        /// <param name="ADFileIdIn">Id archivo AD</param>
        public RuntimeResult<bool> Execute(long CompanyIdIn, long OperatorIdIn, string CaseNumberIn, long LibraryIdIn, DateTime InitDateIn, DateTime EndDateIn, long IdTypePopulationIn, long EstablishmentIn, string TrackingCodeIn, string UserCodeIn, string ACFileIdIn, string AFFileIdIn, string AHFileIdIn, string AMFileIdIn, string ANFileIdIn, string APFileIdIn, string ATFileIdIn, string AUFileIdIn, string CTFileIdIn, string USFileIdIn, string ADFileIdIn)
        {
            try
            {
                ...
                this.OperatorIdIn = OperatorIdIn;
                this.CaseNumberIn = CaseNumberIn;
                this.LibraryIdIn = LibraryIdIn;
                this.InitDateIn = InitDateIn;
                this.EndDateIn = EndDateIn;
                this.IdTypePopulationIn = IdTypePopulationIn;
                this.EstablishmentIn = EstablishmentIn;
                this.TrackingCodeIn = TrackingCodeIn;
                this.UserCodeIn = UserCodeIn;
                this.ACFileIdIn = ACFileIdIn;
                this.AFFileIdIn = AFFileIdIn;
                this.AHFileIdIn = AHFileIdIn;
                this.AMFileIdIn = AMFileIdIn;
                this.ANFileIdIn = ANFileIdIn;
                this.APFileIdIn = APFileIdIn;
                this.ATFileIdIn = ATFileIdIn;
                this.AUFileIdIn = AUFileIdIn;
                this.CTFileIdIn = CTFileIdIn;
                this.USFileIdIn = USFileIdIn;
                this.ADFileIdIn = ADFileIdIn;
                this.ExitMessage = FUNC_ExitMessage();
                this.SaveRipsFiles = FUNC_SaveRipsFiles();
                #endregion
        ...
        ///	
        /// </sumary>
        private string FUNC_ExitMessage()
        {
            return "";
        }
        /// <sumary>
        ///	
        /// </sumary>
        private bool FUNC_SaveRipsFiles()
        {
            ENT_RipsParameters parametersRips = new ENT_RipsParameters()
            {
                InitDate = InitDateIn,
                EndDate = EndDateIn,
                OperatorId = OperatorIdIn,
                IdTypePopulation = IdTypePopulationIn,
                ...
                AMFileId = AMFileIdIn,
                ADFileId = ADFileIdIn,
                Establishment = EstablishmentIn,
                CaseNumber = CaseNumberIn,
                UserCode = UserCodeIn,
                TrackingCode = TrackingCodeIn
            };

            ENT_ActionResult result = Helper.USR_MainRIPS(parametersRips);
            if (result.IsError)
            {
                this.FileName = result.FileName;
                this.ExitMessage = result.ErrorMessage;
                return false;
            }

            if (!result.IsSuccessful)
            {
                this.ExitMessage = result.Messages?.FirstOrDefault();
                return false;
            }
            else
            {
                ...
                {
                    this.ExitMessage = result.Result.ToString();
                }
            }
            return true;
        }
    ...
    public static class Helper
    {
        ...
        public static List<string> USR_ValidateDocument(string documentType, long age, long measurementUnit, long index, List<string> listErrors)
        {
            ...
            switch (documentType)
            {
                ...
                case "CC":
                    ...
                    break;
                case "TI":
                    if (!(age >= 7 && age < 18) && measurementUnit != 1)
                    {
                        valid = false;
                    }
                ...
                case "MS":
                case "RC":
                    if (age >= 0 && age <= 90 && measurementUnit == 3)
                    {
                        valid = true;
                    }
                    ...
                    else if (age >= 0 && age <= 7 && measurementUnit == 1)
                    {
                        valid = true;
                    }
                    break;
        ...
        public static ENT_ActionResult USR_SaveRipsFile(long IdFile, dynamic listSave)
        {
            try
            {
                ...
                ENT_ActionResult result = new ENT_ActionResult();
                string url = "http://davincilb.ophelia.co:8085/ASSURANCE/api/Rips/" + controller;
        ...
        public static dynamic USR_MainRIPS(ENT_RipsParameters parameters)
        {
            try
            {
                ...
                DateTime initDate = Convert.ToDateTime(parameters.InitDate, CultureInfo.CreateSpecificCulture("es-CO"));
                DateTime endDate = Convert.ToDateTime(parameters.EndDate, CultureInfo.CreateSpecificCulture("es-CO"));
                ...
                sql.AppendFormat(" WHERE InitDate = '{0}'", initDate);
                sql.AppendFormat(" AND EndDate = '{0}'", endDate);
        ...
        public static ENT_ActionResult USR_GetCups(long adapterId)
        {
            ...
            if (listTypeDetails.Count == 0)
            {
                return new ENT_ActionResult() { IsError = true, ErrorMessage = "No existen CUPS parametrizados" };
            }
    ...
    public class ENT_USFile : EntityBase
    {
        ...
        [Order]
        [Regex(@"^.{6}$", "La longitud válida son 6 caracteres")] public string AdministeringEntityCode { get { return _AdministeringEntityCode; } set { _AdministeringEntityCode = ValidateValue<string>(value, nameof(AdministeringEntityCode)); } }
        /// <sumary>
        /// TypePerson
        /// </sumary>
    ...
    public class ENT_AFFile : EntityBase
    {
        ...
        private string _AdministeringEntityCode;
        [Order]
        [Regex(@"^.{6}$", "La longitud del campo debe ser 6 caracteres")] public string AdministeringEntityCode { get { return _AdministeringEntityCode; } set { _AdministeringEntityCode = ValidateValue<string>(value, nameof(AdministeringEntityCode)); } }
        /// <sumary>
